...
<body>
    ...
    <div class="button-wrapper">
        ...
        <button class="date-button" data-date="22 April 2024 Monday ">22 Today</button>
        <button class="date-button" data-date="23 April 2024 Tuesday">23 Tomorrow</button>
        <button class="date-button" data-date="24 April 2024 Wednesday">24 Wednesday</button>
        <button class="date-button" data-date="25 April 2024 Thursday">25 Thursday</button>
        <button class="date-button" data-date="26 April 2024 Friday">26 Friday</button>
    </div>
    
    <div class="time-btn">
        <!-- Updated onclick attribute to point to the correct function -->
        <button class="screen-time" data-time="11:00" data-showroom="Showroom A">11:00</button>
        <button class="screen-time" data-time="19:00" data-showroom="Showroom A">19:00 </button>
    </div>
